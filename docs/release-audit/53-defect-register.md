...
- **Open**: R-13 (Maven Central staging — needs credentials), the mixed-writer half of R-20 (fundamental, documented in 13-T-03). None are release blockers.
